...
public class ScalingScannerActivity extends BaseScannerActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        String expressCode = rawResult.getText();
        Toast.makeText(this, "Contents = " + expressCode +
        ...
        //把返回数据存入Intent
        intent.putExtra("scanResult", expressCode);
        ScalingScannerActivity.this.setResult(RESULT_FOR_SCANCODE, intent);
